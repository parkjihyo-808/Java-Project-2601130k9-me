...
//                    for (_3_MemberBase member : members) {
                    if(members.containsKey(inputEmail)) {
                        ...
                        _7_test_260121.memberProject._1_MemberBase member = members.get(inputEmail);
...
//    public static void saveMembers(List<_3_MemberBase> members){
    public static void saveMembers(@org.jetbrains.annotations.UnknownNullability Map<String, _1_MemberBase> members){
