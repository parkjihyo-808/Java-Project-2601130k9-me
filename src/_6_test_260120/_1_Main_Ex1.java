...
public class _1_Main_Ex1 {
    ...
    static void main(String[] args) {
        ...
        _1_MemberBase_Ex1[] members = new _1_MemberBase_Ex1[5];
        ...
        _1_MemberBase_Ex1 loggedInMember = null;
        ...
        // 260120_실습4_풀이, 순서1, 메뉴 변경,
            ...
            switch (choice) {
                case 1: // 회원 가입.
                    ...
                    // _1_NormalMember_Ex1 newMember = new _1_NormalMember_Ex1 (name, email, age);
                    _1_NormalMember_Ex1 newMember = new _1_NormalMember_Ex1 (name, email, age, password);
                    // 배열에 저장.
                ...
                case 3:
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        _1_MemberBase_Ex1 member = members[i];
                        // 주의사항,
                        // 문자열 비교시에는 사용하는 메서드
...
//    1) 저장하는 기능의 메서드 만들기, 정적(static)
    ...
    public static void saveMembers(_1_MemberBase_Ex1[] members, int count){
...
//    2) 불러오는 기능의 메서드 만들기, 정적(static)
    ...
    public static int loadMembers(_1_MemberBase_Ex1[] members){
        ...
        try {
            ...
            while ((line = br.readLine()) != null ) {
                ...
                if( data.length == 4) {
                    ...
                    members[loadCount] = new _1_NormalMember_Ex1(name,email, age, password);
